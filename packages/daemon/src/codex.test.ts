...
describe("parseCodexLine", () => {
  ...
  test("should parse full conversation from user logs", () => {
    const lines = [
      ...
      '{"type":"item.completed","item":{"id":"item_3","type":"command_execution","command":"bash -lc \'cat README.md\'","aggregated_output":"# Scout\\n\\nDelegation platform\\n","exit_code":0,"status":"completed"}}',
      '{"type":"item.completed","item":{"id":"item_4","type":"reasoning","text":"**Preparing summary**"}}',
      '{"type":"item.completed","item":{"id":"item_5","type":"agent_message","text":"Scout is a delegation platform"}}',
