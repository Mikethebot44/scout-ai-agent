          ...
          <Container className="mx-auto p-5 max-w-[600px]">
            <Section className="mt-6">
              ...
              <Section className="mb-0">
                ...
                <Link
                  href="https://cdn.scoutlabs.com/censoredlogin.webm"
              ...
              <Section className="mb-0">
                ...
                <ul className="list-disc pl-6 mb-4">
                  <li className="text-base text-gray-700 mb-1">
                    <Link
                      href="https://docs.scoutlabs.com/docs/"
              ...
              <Section className="mb-0">
                ...
                <ul className="list-disc pl-6 mb-3">
                  <li className="text-base text-gray-700 mb-1">
                    ...
                    Feedback" button in the Scout sidebar to share in-product
                  ...
                  <li className="text-base text-gray-700 mb-1">
                    ...
                    <Link
                      href="mailto:support@scoutlabs.com"
                      className="text-green-600 underline"
                    >
              ...
              <Text className="text-base text-gray-700 mb-3">
                Thanks so much for being part of the early Scout journey!
