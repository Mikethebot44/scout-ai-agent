import { SandboxProvider, SandboxSize } from "@scout/types/sandbox";
import { AIAgent, AIAgentCredentials } from "@scout/agent/types";
import { FeatureFlags } from "@scout/daemon/shared";
...
export type CreateSandboxOptions = {
  ...
  skipSetupScript?: boolean; // Skip running scout-setup.sh during sandbox setup
  setupScript?: string | null; // Custom setup script to override repository's scout-setup.sh
