...
import { getGithubPRStatus } from "@scout/shared/github-api/helpers";
import { upsertGithubPR } from "@scout/shared/model/github";
import { updateThread, getThread } from "@scout/shared/model/threads";
import {
...
export async function openPullRequestForThread({
  ...
  prBody += [
    "\n\n",
    "🌿 Generated by [Terry](https://www.scoutlabs.com)",
    "\n\n---\n\n",
    "ℹ️ Tag @scout-labs to ask questions and address PR feedback",
    "\n\n",
