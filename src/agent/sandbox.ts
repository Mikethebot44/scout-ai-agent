...
import { DB } from "@scout/shared/db";
...
import { getFeatureFlagsForUser } from "@scout/shared/model/feature-flags";
import {
...
export async function createSandboxForThread({
  ...
  try {
    ...
    if (
      ...
      error.message.includes("scout-setup.sh failed:")
    ) {
