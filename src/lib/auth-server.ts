...
import { getUserSettings } from "@scout/shared/model/user";
import { getUserFlags } from "@scout/shared/model/user-flags";
...
export async function validInternalRequestOrThrow() {
  ...
  const secret = requestHeaders.get("X-Scout-Secret");
