...
import { AccessTier } from "@scout/shared";
import {
  getSubscriptionInfoForUser,
  setSignupTrialPlanForUser,
} from "@scout/shared/model/subscription";
  ...
  async function getStripeCheckoutUrl(
    ...
    if (flags.shutdownMode) {
      throw new UserFacingError(
        "New subscriptions are no longer available. Scout is shutting down on February 14th, 2026.",
      );
    }
