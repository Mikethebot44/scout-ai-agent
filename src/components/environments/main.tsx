...
import { McpConfig } from "@scout/sandbox/mcp-config";
      ...
      <div className="flex flex-col justify-start h-full w-full max-w-4xl">
        <div className="mb-6 p-4 bg-muted/50 rounded-lg border">
          ...
          <p className="text-sm text-muted-foreground">
            Scout runs in an isolated Linux environment with full development
        ...
        <div className="flex flex-col gap-2 mt-10">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-xs text-muted-foreground">
              ...
              be available to Scout. Learn more about which formats are
