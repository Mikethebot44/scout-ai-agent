  ...
  return (
    <div className="p-4 max-w-2xl">
      <ChatError
        ...
        errorInfo={`To github.com:scout-labs/scout.git
! [rejected]        scout/fca1cf -> scout/fca1cf (non-fast-forward)
error: failed to push some refs to 'github.com:scout-labs/scout.git'
...
export const GitPushFailedMobileOverflow: Story = () => {
  const veryLongErrorMessage = `To github.com:scout-labs/scout.git
! [rejected]        scout/very-long-branch-name-that-could-cause-overflow-issues-on-mobile-devices -> scout/very-long-branch-name-that-could-cause-overflow-issues-on-mobile-devices (non-fast-forward)
error: failed to push some refs to 'github.com:scout-labs/scout.git'
