...
import { UIMessage, ThreadStatus } from "@scout/shared";
import { AIAgent } from "@scout/agent/types";
import { BootingSubstatus } from "@scout/sandbox/types";
...
function getAgentRateLimitMessage({
  ...
  return (
    <div className="flex flex-col">
      ...
      {agent === "claudeCode" && (
        <Link
          href="https://docs.scoutlabs.com/docs/agent-providers/claude-code#automatic-rate-limit-handling"
          target="_blank"
