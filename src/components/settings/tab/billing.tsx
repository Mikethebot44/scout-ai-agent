    ...
    <Card className="mx-auto w-full max-w-2xl border-destructive/50">
      <CardHeader>
        <CardTitle className="text-base text-destructive">
          Scout is Shutting Down
        </CardTitle>
      </CardHeader>
      <CardContent>
        <p className="text-sm text-muted-foreground">
          New subscriptions are no longer available. Scout will shut down on
          February 9th, 2026.{" "}
          <a
  ...
  if (signupTrialInfo?.daysRemaining === 0) {
    return (
      <span className="text-muted-foreground">
        Trial Expired — Please select a plan to continue using Scout.
      </span>
    );
  }
  return null;
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="space-y-4">
        <SettingsSection
          label="Subscription"
          description="Your subscription lets you run tasks on the Scout platform."
        >
