...
import { SlackAccountWithMetadata } from "@scout/shared/db/types";
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <SettingsSection
        ...
        description={
          <>
            Connect your Slack workspace to interact with Scout through
            Slack.{" "}
            <Link
              href="https://docs.scoutlabs.com/docs/integrations/slack-integration"
              target="_blank"
