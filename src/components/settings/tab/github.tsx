  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <SettingsSection label="Repository Configuration">
        <div className="flex flex-col gap-4">
          <SettingsWithExternalLink
            ...
            description="Manage which GitHub repositories Scout can access"
      ...
      <SettingsSection
        ...
        description="Configure how Scout creates and manages pull requests"
      >
        <div className="flex flex-col gap-4">
          <SettingsWithCTA
            label="Default pull request stage"
            description="Set the default stage of pull requests Scout creates"
          >
      ...
      {/* @-mention settings */}
      <SettingsSection
        label="@scout-labs Defaults"
        description="Configure what happens when @scout-labs is tagged on GitHub"
      >
        <div className="flex flex-col gap-4">
          <SettingsCheckbox
            label="Create new task when @scout-labs is tagged on GitHub"
