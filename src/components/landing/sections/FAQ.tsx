...
const faqs = [
  {
    ...
    answer:
      "Scout is an AI-powered coding assistant platform that allows you to run coding agents in parallel inside remote sandboxes. This enables you to work on multiple tasks concurrently and asynchronously, with agents that can make edits, run tests, verify changes, and create commits and PRs.",
  },
  {
    question: "Which coding agents does Scout support?",
    answer: (
      <>
        Scout supports{" "}
        <a
  ...
  },
  {
    ...
    answer:
      "Yes! Scout supports both Claude and ChatGPT subscriptions. You can connect your existing Claude or ChatGPT subscription within your agent settings.",
  },
  {
    question: "How does Scout handle security?",
    answer: (
      <>
        ...
        <Link
          target="_blank"
          href="https://docs.scoutlabs.com/docs/security-permissions"
