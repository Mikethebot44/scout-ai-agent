  ...
  const integrations = [
    {
      ...
      action: "@scout-labs please fix this",
    },
    {
      icon: <SlackIcon className="size-5" />,
      title: "#engineering",
      subtitle: "Sarah Johnson 2:34 PM",
      action: "@scout update hero section",
    },
    {
    ...
    },
    {
      ...
      action: "@scout-labs review this",
    },
    {
      icon: <SlackIcon className="size-5" />,
      title: "#product",
      subtitle: "Alex Chen 11:23 AM",
      action: "@scout implement feature",
    },
    {
      icon: <LinearIcon className="size-5" />,
    ...
    },
    {
      ...
      action: "@scout-labs upgrade pkgs",
    },
    {
      icon: <SlackIcon className="size-5" />,
      title: "#backend",
      subtitle: "Jamie Lee 9:15 AM",
      action: "@scout fix API timeout",
    },
    {
      icon: <JiraIcon className="size-5" />,
    ...
    },
    {
      ...
      action: "@scout-labs optimize this",
    },
    {
      icon: <SlackIcon className="size-5" />,
      title: "#design",
      subtitle: "Morgan Davis 4:45 PM",
      action: "@scout update button styles",
    },
    {
      icon: <GithubIcon className="size-5" />,
      title: "GitHub PR #201",
      subtitle: "Add dark mode toggle",
      action: "@scout-labs implement this",
    },
    {
      icon: <SlackIcon className="size-5" />,
      title: "#frontend",
      subtitle: "Taylor Reed 10:30 AM",
      action: "@scout optimize loading",
    },
  ];
