...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Scout Labs" }],
  creator: "Scout Labs",
  publisher: "Scout Labs",
  robots: {
    index: true,
    follow: true,
    nocache: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Scout - AI coding agents platform",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://www.scoutlabs.com",
  },
  metadataBase: new URL("https://www.scoutlabs.com"),
};
