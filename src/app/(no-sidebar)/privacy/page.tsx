...
export const metadata: Metadata = {
  title: "Privacy Policy - Scout Labs",
  description:
    "Privacy Policy for Scout Labs Inc. Learn how we collect, use, and protect your personal information when using our AI-powered coding assistant platform.",
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: "https://www.scoutlabs.com/privacy",
  },
};
          ...
          <div className="space-y-8 text-foreground leading-relaxed">
            <section>
              <p className="text-lg leading-relaxed">
                Scout Labs Inc. ("Scout Labs," "we," "us," or "our") is
                committed to protecting your privacy. This Privacy Policy
                describes how we collect, use, share, and protect information
                when you access or use our website at scoutlabs.com, its
