...
export const metadata: Metadata = {
  title: "Terms of Service - Scout Labs",
  description:
    "Terms of Use for Scout Labs Inc., an AI-powered coding assistant platform that allows you to run coding agents in parallel inside remote sandboxes.",
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: "https://www.scoutlabs.com/terms",
  },
};
          ...
          <div className="space-y-8 text-foreground leading-relaxed">
            <section>
              <p className="text-lg mb-6">
                Welcome to Scout Labs Inc. ("Scout Labs," "Company," "we,"
                "us," or "our"). These Terms of Use ("Terms") govern your access
                to and use of our website at scoutlabs.com, its
            ...
            <section>
              ...
              <div className="bg-muted/30 p-4 rounded-lg border">
                <p className="font-mono text-sm space-y-1">
                  ...
                  <span className="block">Email: support@scoutlabs.com</span>
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-muted/30 p-6 rounded-lg border">
                ...
                <div className="font-mono text-sm space-y-1">
                  ...
                  <p>Email: support@scoutlabs.com</p>
                </div>
              </div>
            </section>
          </div>
