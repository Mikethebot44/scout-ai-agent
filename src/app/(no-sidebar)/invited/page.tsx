...
import { validateAccessCode } from "@scout/shared/model/access-codes";
import { db } from "@/lib/db";
import { OG_IMAGE_URL } from "@/lib/constants";

export const metadata: Metadata = {
  title: "You've been invited to Scout",
  description:
    "Join Scout with your exclusive access code and start using background agents for Claude Code.",
  openGraph: {
    title: "You've been invited to Scout",
    description:
      "Join Scout with your exclusive access code and start using background agents for Claude Code.",
    url: "https://www.scoutlabs.com/invited",
    siteName: "Scout",
    images: [
      {
        url: OG_IMAGE_URL,
        width: 1200,
        height: 630,
        alt: "Scout - Background agents for Claude Code",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://www.scoutlabs.com/invited",
  },
  robots: {
    index: false,
    follow: false,
