          ...
          <div className="space-y-4">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <Image
                    src="https://cdn.scoutlabs.com/github-mark-Z5SF.svg"
                    alt="GitHub"
                    width={20}
                    height={20}
                  ...
                  />
                  <Image
                    src="https://cdn.scoutlabs.com/github-mark-white-Ue4J.svg"
                    alt="GitHub"
                    width={20}
                    height={20}
        ...
        <div className="max-w-lg space-y-6 relative z-10 w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Join thousands of developers building with Scout
            </p>
          </div>
