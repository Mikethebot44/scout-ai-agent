...
The Slack integration allows users to interact with Scout through Slack. Users can create tasks directly from Slack messages.

#### 1. Create a Slack App

1. Go to https://api.slack.com/apps
2. Click **"Create New App"** → **"From scratch"**
3. Give your app a name (e.g., "Scout-Dev-YourName")
...
2. Under **"Redirect URLs"**, add:
   ...
   - For production: `https://www.scoutlabs.com/api/auth/slack/callback`
...
2. Set the **"Request URL"** to:
   ...
   - For production: `https://www.scoutlabs.com/api/webhooks/slack`
